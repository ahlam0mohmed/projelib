  ...
  <form class="card-body" action="/save_book" method="POST" enctype="multipart/form-data">
    ...
    <div class="row g-3">
      ...
      <div class="col-md-6">
        ...
        <input name="book_detile" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-username"> سعر الكتاب</label>
        <input name="book_price" type="number" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-username"> عدد الصفحات</label>
        <input name="number_pages" type="number" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
      <div class="col-md-6">
